...
class WebHeckeOrbits_weight1(WebDict):
    r"""
    ...
    def __init__(self, name, level, character, parent=None,**kwds):
        ...
        self.parent = parent
        super(WebHeckeOrbits_weight1, self).__init__(
    ...
    def from_db(self, l):
        ...
        res = {}
        for lbl in l:
            F = WebNewForm_weight1(self.level, self.character, lbl, parent=self.parent)
...
class WebModFormSpace_weight1(WebObject, CachedRepresentation):
    r"""
    ...
    def __init__(self, level=1, character=1, cuspidal=True, prec=10, bitprec=53, update_from_db=True, update_hecke_orbits=True, **kwargs):
        ...
        self._properties = WebProperties(
            ...
            WebSageObject('group'),
            WebInt('sturm_bound'),
            WebHeckeOrbits_weight1('hecke_orbits', level,
...
class WebModFormSpaceProperty_weight1(WebProperty):

    def __init__(self, name, level=1, character=1, value=None,update_hecke_orbits=False,include_in_update=False):
        self.level = level
        self.weight = 1
        self.character = character
        if value is None:
